...
### Loan Term with Current Balance

**Problem:** How long will it take to pay off a loan which has a current balance of $58,000 and an interest rate of 7.5% per year if the monthly payments are $850?

**Steps:**
1. `7.5` `ENTER` `12` `÷` `i` (monthly rate)
2. `58000` `PV` (current loan balance)
...
**Problem:** What monthly payment is necessary to fully amortize a $130,000 loan in 30 years at an interest rate of 5.75% per year?

**Steps:**
1. `360` `n` (30 years × 12 months)
2. `5.75` `ENTER` `12` `÷` `i` (monthly rate)
3. `130000` `PV` (loan amount)
4. `PMT` (calculate payment)
...
**Problem:** What will be the balance at the end of the tenth year on a monthly payment $130,000 loan with a 30-year amortization period at an interest rate of 5.75% per year?

**Steps:**
1. `360` `n` (30 years × 12 months)
2. `5.75` `ENTER` `12` `÷` `i` (monthly rate)
3. `130000` `PV` (loan amount)
4. `PMT` (calculate payment: -$758.48)
...
**Problem:** What will be the lender's yield on a monthly payment $130,000 loan with a 30-year amortization period and an interest rate of 5.75% per year if the lender charges the buyer a loan fee of three points?
...
3. `130000` `PV` (loan amount)
4. `PMT` (calculate payment: -$758.48)
5. `130000` `ENTER` `3` `%` `-` `PV` (net proceeds: 97% of loan)
6. `i` (calculate actual yield)
7. `12` `×` (convert to annual)

**Result:** 6.03% annual yield

### Cash Equivalent Value of a Loan

**Problem:** What is the cash equivalent value of a monthly payment $130,000 loan provided by the seller of a property if it has a 30-year amortization period and an interest rate of 5.75% per year, and the market interest rate is 7.0%?

**Steps:**
1. `360` `n` (30 years × 12 months)
2. `5.75` `ENTER` `12` `÷` `i` (contract rate)
3. `130000` `PV` (loan amount)
4. `PMT` (calculate payment: -$758.48)
5. `7` `ENTER` `12` `÷` `i` (market rate)
6. `PV` (calculate present value at market rate)

**Result:** $-114,080.46 (cash equivalent value)
...
**Result:** $16,517.69 (compare to $16,435.51 in END mode)
